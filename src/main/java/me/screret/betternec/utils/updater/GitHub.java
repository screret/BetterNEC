package me.screret.betternec.utils.updater;
...
public class GitHub {
    ...
    public static void fetchLatestRelease() {
        try {
            GitHub.latestRelease = Utils.getJson("https://api.github.com/repos/screret/BetterNec/releases").getAsJsonArray().get(0).getAsJsonObject();
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
